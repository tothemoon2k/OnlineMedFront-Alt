                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-semibold text-green-800 mb-4">
                                Verified & Accepted By Employers
                            </h3>
                            <p className="text-gray-600">
                                Notes are accepted by employers nationwide. Includes all required medical verification details.
                            </p>
                    ...
                    <div className="max-w-3xl mx-auto">
                        {[
                            ...
                            },
                            {
                                ...
                                answer: "Yes, our doctor's notes are accepted by employers nationwide. They contain all required medical information, proper formatting, and verification elements that HR departments need. We offer a 99.9% acceptance guarantee or your money back."
                            },
                            {
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4 mb-8">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-gray-700">99.9% Employer Acceptance Guaranteed</span>
                                        </div>
                                        <div className="flex items-center">
                                            <svg className="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
