...
const GeneralA = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="pt-20 pb-32 md:pt-40 md:pb-44 bg-gradient-to-r from-blue-50 to-blue-100">
                <div className="max-w-7xl mx-auto px-8 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        {/* Left Column - Restored to original with more spacing */}
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.5 }}
                            className="space-y-12" // Added vertical spacing
                        >
                            <div className="space-y-8"> {/* Content group with spacing */}
                                <h1 className="text-[3.5rem] font-bold text-gray-900 sm:text-5xl md:text-6xl leading-tight">
                                    Get a Verifiable Doctors Note in <span className="text-blue-600 border-b-4 border-blue-300">Under 10 Mins</span>
                                </h1>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center md:space-x-8">
                                    <div className="-space-x-2 hidden md:flex"> {/* Increased spacing */}
                                        {reviewAvatars.map((i) => (
                                            <img
                                                key={i}
                                ...
                                <div className="hidden md:flex text-sm text-gray-500 items-center">
                                    ...
                                    99.9% Acceptance Rate at Schools & Workplaces
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-2xl shadow-xl p-10" // Increased padding
                        >
                            <div className="mb-8"> {/* Increased margin */}
                                <h2 className="text-2xl font-bold text-gray-900 mb-3">
                                    Where will you use this note?
                                </h2>
                            </div>
                            ...
                            <div className="space-y-4"> {/* Increased spacing between buttons */}
                                <motion.button
                                    ...
                                    className="w-full py-5 px-6 text-center bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-200 font-semibold text-lg"
                                >
                                    Work
                                </motion.button>
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-100"> {/* Increased margin */}
                ...
                <div className="max-w-7xl mx-auto px-8 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">
                            The Trusted Solution for Medical Documentation
                        </h2>
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Real, Verifiable, Delivered in Minutes
                        </p>
                    </div>
